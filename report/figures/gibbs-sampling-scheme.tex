...
\begin{document}
  \begin{graph}
    ...
    \node[layer,fit=(A1) (E1),label={[label distance=0cm]-90:\large $v^{(0)}$}] (VL1) {};

    \node[hidden] (X1) [above=2.5cm of E1] {};
    \node[hidden] (Y1) [right=of X1] {};
    \node[hidden] (Z1) [right=of Y1] {};
    \node[layer,fit=(X1) (Z1),label={[label distance=0cm]90:\large $h^{(0)}$}] (HL1) {};
    ...
    \node[layer,fit=(A2) (E2),label={[label distance=0cm]-90:\large $v^{(1)}$}] (VL2) {};

    \node[hidden] (X2) [above=2.5cm of E2] {};
    \node[hidden] (Y2) [right=of X2] {};
    \node[hidden] (Z2) [right=of Y2] {};
    \node[layer,fit=(X2) (Z2),label={[label distance=0cm]90:\large $h^{(1)}$}] (HL2) {};
    ...
    \node[layer,fit=(A3) (E3),label={[label distance=0cm]-90:\large $v^{(2)}$}] (VL3) {};

    \path[->] (VL1) edge node {\large $p[ϑ](h\vert v)$} (HL1);
    \path[->] (VL2) edge node {\large $p[ϑ](h\vert v)$} (HL2);
    \path[->] (HL1) edge node {\large $p[ϑ](v\vert h)$} (VL2);
    \path[->] (HL2) edge node {\large $p[ϑ](v\vert h)$} (VL3);
