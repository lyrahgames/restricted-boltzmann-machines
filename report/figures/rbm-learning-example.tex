...
\begin{document}
  \begin{graph}
    ...
    \node[layer,fit=(A) (E),inner sep = 10pt,label={[label distance=0cm]270:\small Movie Ratings}] (L1) {};
    \node[layer,fit=(X) (Z),inner sep = 10pt,label={[label distance=0cm]90:\small Features}] (L2) {};
  \end{graph}
\end{document}